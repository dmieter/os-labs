...
1. Распакуйте файл labfiles-3-26.zip в рабочую директорию. 
...
2. В качестве основного задания от Преподавателя необходимо создать файл-отчет по тестированию студентов за 2026 год по двум предметам Преподавателя.

i. Файл с фамилиями, группами (без указания года) и оценками по всем успешными попыткам (оценка >= 3) через запятую по всем тестам за 2026 год например:
```bash
KozlovskiyY,A-09,5
ButovA,A-06,4
YemelyanovD,A-06,3
...
* Четный вариант: об общем количестве попыток без правильных ответов в вашей группе (6, 9 или 21) за все время по всем тестам
* Нечетный вариант: об общем количестве троек (оценка == 3) за последние три года (24-26 гг.) по всем тестам
...
3. В качестве индивидуального задания при выполнении поручения Преподавателя, Вам предлагается подправить собственные результаты в исходных файлах и в отчетах, представляемых Преподавателю.
	1. С помощью текстового редактора sed Вам предлагается исправить в лучшую сторону:
		1. Четный вариант: Удалить свои неудачные попытки по тестам в исходных файлах TEST-N.
...
4. Результаты выполнения задания загрузите в собственный github репозиторий. Приложите скриншоты выполнения основных этапов.
Сообщите преподавателю о готовности работы (перешлите в мессенджер ссылку на github репозиторий).
